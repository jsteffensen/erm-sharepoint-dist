...
`],encapsulation:2,changeDetection:0})}return a})();function W(a,e=0,t=100){return Math.max(e,Math.min(t,a))}var be=(()=>{class a{static \u0275fac=function(s){return new(s||a)};static \u0275mod=q({type:a});static \u0275inj=j({imports:[H]})}return a})();var k=class{_box;_destroyed=new L;_resizeSubject=new L;_resizeObserver;_elementObservables=new Map;constructor(e){this._box=e,typeof ResizeObserver<"u"&&(this._resizeObserver=new ResizeObserver(t=>this._resizeSubject.next(t)))}observe(e){return this._elementObservables.has(e)||this._elementObservables.set(e,new I(t=>{let s=this._resizeSubject.subscribe(t);return this._resizeObserver?.observe(e,{box:this._box}),()=>{this._resizeObserver?.unobserve(e),s.unsubscribe(),this._elementObservables.delete(e)}}).pipe(P(t=>t.some(s=>s.target===e)),U({bufferSize:1,refCount:!0}),R(this._destroyed))),this._elementObservables.get(e)}destroy(){this._destroyed.next(),this._destroyed.complete(),this._resizeSubject.complete(),this._elementObservables.clear()}},we=(()=>{class a{_cleanupErrorListener;_observers=new Map;_ngZone=h(f);constructor(){typeof ResizeObserver<"u"}ngOnDestroy(){for(let[,t]of this._observers)t.destroy();this._observers.clear(),this._cleanupErrorListener?.()}observe(t,s){let r=s?.box||"content-box";return this._observers.has(r)||this._observers.set(r,new k(r)),this._observers.get(r).observe(t)}static \u0275fac=function(s){return new(s||a)};static \u0275prov=b({token:a,factory:a.\u0275fac,providedIn:"root"})}return a})();export{we as a,G as b,pe as c,be as d};
